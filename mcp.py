...
async def create_solution_idea(
    ...
    GapCategoryIds: Annotated[str, Field(description="List of gap category IDs that this solution addresses. Example: ['64e20793-0aab-4b79-aa0e-f7eb3c1df4e4', 'another-gap-id']")],
    OcrProponentIds: Annotated[str, Field(description="List of OCR proponent organization IDs. Example: ['94df18c7-3f93-400e-9196-a2de00d79315']")],
